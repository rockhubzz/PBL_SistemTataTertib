...
.select2-container .select2-results__options {
    ...
    .select2-container .select2-selection--single {
        height: 38px; /* Match your input field height */
        display: flex;
        align-items: center;
    }
    ...
    .select2-container--default .select2-selection--single {
        ...
        border-radius: 4px;     /* Match input field border-radius */
    }
...
.success-message {
    ...
    margin-bottom: 15px; /* Space below success message */
        ...
        overflow-y: auto; /* Add vertical scroll when options exceed max height */
        display: block;   /* Ensure the dropdown behaves as a block-level element */
    }</style>
<script>
